...
/**
  ...
  ☻/  * @file Crops recipe Mystical Agriculture script
...
ServerEvents.recipes(event => {
  ...
  JsonIO.write('kubejs/server_scripts/modtype_specific/mysticalagriculture/all_seeds.json', JsonExport)
  ...
  if (Platform.isLoaded('botanypots')) {
    ...
    //Fix drops, fix cruxes, check for missing recipes
