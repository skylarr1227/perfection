...
Last README file update: Sat Dec 31 23:34:25 CST 2022
...
command.atumweather
command.atumweather.clear
command.atumweather.clear.time
command.atumweather.sandstorm
command.atumweather.sandstorm.time
command.back
command.ban
command.ban-ip
...
command.locate.atum:gatehouse
command.locate.atum:girafi_tomb
command.locate.atum:mineshaft
command.locate.atum:pyramid
command.locate.atum:ruin
command.locate.atum:tomb
...
command.locate.castle_in_the_sky:castle_in_the_sky
command.locate.desert_pyramid
command.locate.doom:archmaykr
command.locate.doom:maykr
command.locate.doom:motherdemon
command.locate.doom:netherportal
command.locate.doom:portal
command.locate.doom:titan_skull
...
command.locate.graveyard:haunted_house
command.locate.graveyard:large_birch_tree
command.locate.graveyard:large_walled_graveyard
command.locate.graveyard:medium_walled_graveyard
command.locate.graveyard:mushroom_grave
command.locate.graveyard:small_desert_grave
command.locate.graveyard:small_grave
command.locate.graveyard:small_mountain_grave
command.locate.graveyard:small_savanna_grave
command.locate.graveyard:small_walled_graveyard
command.locate.graveyard:small_walled_graveyard_desert
command.locate.graveyard:small_walled_graveyard_savanna
...
command.locate.paraglider:nether_horned_statue
command.locate.paraglider:tarrey_town_goddess_statue
command.locate.paraglider:underground_horned_statue
...
command.locate.skyvillages:skyvillage
...
command.locate.totw_additions:end_tower
command.locate.totw_additions:nether_tower
...
command.mobenchantment
command.mobenchantment.clear
command.mobenchantment.clear.targets
command.mobenchantment.clear.targets.MobEnchantment
command.mobenchantment.give
command.mobenchantment.give.targets
command.mobenchantment.give.targets.MobEnchantment
command.msg
command.msg.targets
...
command.progressivebosses.legacy_difficulty
command.progressivebosses.legacy_difficulty.targetPlayer
command.progressivebosses.legacy_difficulty.targetPlayer.get
command.progressivebosses.legacy_difficulty.targetPlayer.get.dragon
command.progressivebosses.legacy_difficulty.targetPlayer.get.wither
...
command.structure_gel.getspawns.eitd_eyes
